...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('shop_dellin_settings')) {
            return;
        }

        Schema::create('shop_dellin_settings', function (Blueprint $table) {
            $table->id();
            // API ключ Деловых линий
            $table->string('appkey')->comment('AppKey Деловых линий');
    ...
    {
        Schema::dropIfExists('shop_dellin_settings');
    }
};
