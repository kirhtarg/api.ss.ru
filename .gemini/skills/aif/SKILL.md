...
```bash
node ~/.gemini/skills/aif/references/update-config.mjs \
  --template ~/.gemini/skills/aif/references/config-template.yaml \
...
3. Run `node ~/.gemini/skills/aif/references/update-config.mjs --template ~/.gemini/skills/aif/references/config-template.yaml --target .ai-factory/config.yaml --payload .ai-factory/config.update.json`
