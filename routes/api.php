...
Route::middleware(['cors', 'throttle:public'])->group(function () {
    ...
    Route::options('/public/shop/yandex/settings/active', function () {
        return response()->json([], 200);
    });
    Route::get('/public/shop/yandex/settings/active', [App\Http\Controllers\Api\Public\ShopYandexDeliveryController::class, 'getActiveSettings']);
    ...
    Route::middleware(['auth:sanctum', 'role:admin,manager,site'])->prefix('admin')->group(function () {
        ...
        Route::middleware([\App\Http\Middleware\CustomCors::class, 'auth:sanctum', 'role:admin,manager'])->prefix('shop')->group(function () {
            ...
            Route::prefix('goods')->group(function () {
                ...
                Route::post('/profiles/{profile}/feed-price-stock/runs/{run}/clear-missing-stocks', [\App\Http\Controllers\Admin\BikeproductsCatalogController::class, 'clearMissingInFeedStocks']);
                Route::post('/profiles/{profile}/feed-price-stock/runs/{run}/fill-source-name', [\App\Http\Controllers\Admin\BikeproductsCatalogController::class, 'fillFeedPriceStockSourceName']);
                Route::delete('/profiles/{profile}/feed-price-stock/runs/{run}', [\App\Http\Controllers\Admin\BikeproductsCatalogController::class, 'deleteFeedPriceStockRun']);
                    ...
                    Route::get('/snapshots/{snapshot}/variation-audit/stats', [\App\Http\Controllers\Admin\BikeproductsCatalogController::class, 'variationAuditStats']);
                    ...
                    Route::get('/snapshots/{snapshot}/image-sync/{actionRun}', [\App\Http\Controllers\Admin\BikeproductsCatalogController::class, 'imageSyncStatus']);
