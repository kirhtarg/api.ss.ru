...
{
    protected $fillable = ['public_id', 'partner_id', 'partner_order_id', 'event', 'payload', 'status', 'attempts', 'response_status', 'duration_ms', 'response_body', 'last_error', 'next_attempt_at', 'delivered_at'];
