...
The argument after `/skills aif-explore` can be:
...
- "This feels solid enough to plan. Want me to start `/skills aif-plan`?"
...
3. **Offer to capture when decisions are made**
   ...
   | New task/feature | Run `/skills aif-plan` | `paths.plan` or `paths.plans/<branch-or-slug>.md` |
...
```
Save these exploration results to the resolved research path so we can /clear and /skills aif-plan can reuse them?
...
```
User: /skills aif-explore add-auth-system
...
- **Flow into action**: "Ready to plan? Run `/skills aif-plan`"
...
**Next steps** (if ready):
- Create a plan: /skills aif-plan [fast|full] <description>
