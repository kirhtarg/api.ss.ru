...
- `/skills aif-security-checklist` — Full audit checklist
- `/skills aif-security-checklist auth` — Authentication & sessions
- `/skills aif-security-checklist injection` — SQL/NoSQL/Command injection
- `/skills aif-security-checklist xss` — Cross-site scripting
- `/skills aif-security-checklist csrf` — Cross-site request forgery
- `/skills aif-security-checklist secrets` — Secrets & credentials
- `/skills aif-security-checklist api` — API security
- `/skills aif-security-checklist infra` — Infrastructure security
- `/skills aif-security-checklist prompt-injection` — LLM prompt injection
- `/skills aif-security-checklist race-condition` — Race conditions & TOCTOU
- `/skills aif-security-checklist ignore <item>` — Ignore a specific check item
...
**When the user runs `/skills aif-security-checklist ignore <item>`:**
...
**When running any audit (`/skills aif-security-checklist` or a specific category):**
...
└─────────────────┴──────────────────────────────────────┴────────────┘
⚠️  2 items ignored. Run `/skills aif-security-checklist` without ignores to see full audit.
```
