...
`/skills aif-review` is read-only for context artifacts by default. Do not modify context files unless user explicitly asks.
...
**User:** `/skills aif-review`
Review staged changes in current repository.

**User:** `/skills aif-review 123`
Review PR #123 using GitHub CLI.

**User:** `/skills aif-review https://github.com/org/repo/pull/123`
Review PR from URL.

**User:** `/skills aif-review 2.x`
Review all commits on the current branch compared to branch `2.x`.

**User:** `/skills aif-review main`
