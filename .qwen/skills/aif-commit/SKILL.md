...
If argument provided (e.g., `/skills aif-commit auth`):
- Use it as the scope
...
- `/skills aif-commit` has no implicit strict mode — context gates are warning-first unless user explicitly requests blocking behavior
