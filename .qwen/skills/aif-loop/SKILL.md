...
5. Suggest next skills based on artifact type:
   - API spec -> `/skills aif-plan` to implement it
   - Code -> `/skills aif-verify` to check it
   - Docs -> `/skills aif-docs` to integrate it
...
```text
💡 Context is growing. Recommended: /clear then /skills aif-loop resume
...
```text
/skills aif-loop new OpenAPI 3.1 spec + DDD notes + JSON examples
/skills aif-loop resume
/skills aif-loop resume courses-api-ddd
/skills aif-loop status
/skills aif-loop stop
/skills aif-loop list
/skills aif-loop history
/skills aif-loop history courses-api-ddd
/skills aif-loop clean courses-api-ddd
/skills aif-loop clean --all
```
