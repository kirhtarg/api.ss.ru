...
- `/skills aif-best-practices` — Full overview
- `/skills aif-best-practices naming` — Naming conventions
- `/skills aif-best-practices structure` — Code organization
- `/skills aif-best-practices errors` — Error handling
- `/skills aif-best-practices testing` — Testing practices
- `/skills aif-best-practices review` — Code review checklist
...
- [ ] **Security**: Any vulnerabilities? (see `/skills aif-security-checklist`)
