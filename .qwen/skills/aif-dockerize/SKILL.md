...
Same detection as `/skills aif-build-automation` Step 2.2.
...
Suggest follow-up: `/skills aif-build-automation` for Docker targets, `/skills aif-docs` for documentation.
