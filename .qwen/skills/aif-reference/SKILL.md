...
- You want reusable domain context for `/skills aif-plan`, `/skills aif-implement`, `/skills aif-explore`, or `/skills aif-grounded`
...
- **`/skills aif-reference list`** - read and display `<resolved references dir>/INDEX.md` or list files in the directory
- **`/skills aif-reference show <name>`** - read and display the reference content (`.md` is optional)
- **`/skills aif-reference delete <name>`** - ask for confirmation, delete the file, and update `INDEX.md`

## Integration With Other Skills

References in the resolved references directory are available to all AI Factory skills:
- `/skills aif-plan` and `/skills aif-implement` can read them for domain context
- `/skills aif-grounded` can use them as evidence sources
- `/skills aif-explore` can reference them during research
