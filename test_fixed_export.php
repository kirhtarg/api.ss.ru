...
echo "Testing fixed export...\n";

// Создаем экспорт с правильными настройками
$exportFile = ExportFile::create([
    'created_by' => 1,
    'filename' => 'export_' . time() . '_' . uniqid() . '.xlsx',
    'original_filename' => 'Исправленный экспорт ' . date('d.m.Y H:i') . '.xlsx',
    'file_path' => '',
    'format' => 'excel',
    'status' => 'pending',
    'total_rows' => 0,
    'file_size' => 0,
    'export_config' => [
        'fields' => ['id', 'name', 'variation', 'prop_1', 'attr_1'], // Используем ID атрибута
        'filters' => [
        ...
        'field_labels' => [
            ...
            'attr_1' => 'Цвет'  // Используем ID атрибута
        ],
