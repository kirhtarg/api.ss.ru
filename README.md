...
API SS RU — Laravel API-бэкенд для skateandsnow.ru. Он обслуживает сайт, магазин, административную панель и защищённые партнёрские интеграции.
...
- **Partner API**: HMAC-аутентификация, оформление заказов, доставка, платежи, комиссии, выплаты и webhook
...
|---|---|
| [Грузовые места](docs/delivery-packages.md) | Упаковка и расчёт доставки |
| [Ozon Seller API](docs/OZON_SELLER_API.md) | Настройка интеграции Ozon |
| [Вариации Ozon](docs/OZON_SELLER_VARIATIONS.md) | Категории, офферы и вариации |
| [Partner API](docs/PARTNER_API.md) | Подключение, безопасность и эксплуатация |
