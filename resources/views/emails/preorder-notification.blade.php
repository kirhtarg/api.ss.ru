...
<head>
    ...
    <title>Новый предзаказ товара</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        ...
        <!-- Основной контент -->
        <div class="content">
            <!-- Уведомление о новом предзаказе -->
            <div class="alert-box">
                <h2>📦 Новый предзаказ товара!</h2>
                <p>Поступил новый предзаказ, требующий обработки.</p>
            </div>
            ...
            <div class="preorder-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value highlight">{{ $preorder->quantity }} шт.</span>
                </div>
            ...
            @if($preorder->customer_name || $preorder->customer_email || $preorder->customer_phone)
            <div class="preorder-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $preorder->customer_name }}</span>
                </div>
                @endif
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $preorder->customer_email }}</span>
                </div>
                @endif
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{!! $preorderPhoneLink ?? $preorder->customer_phone !!}</span>
                </div>
                @endif
        ...
        <!-- Footer -->
        <div class="footer">
            <p>Это автоматическое уведомление о новом предзаказе.</p>
            @if(isset($siteInfo['main_site']) && $siteInfo['main_site'])
