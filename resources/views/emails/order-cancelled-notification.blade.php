...
<head>
    ...
    <title>Заказ отменен #{{ $order->order_number }}</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            <div class="alert-box">
                <h2>❌ Заказ отменен пользователем</h2>
                <p>Пользователь отменил неоплаченный заказ. Товары возвращены на склад.</p>
            </div>
            ...
            <div class="order-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value highlight">Отменен</span>
                </div>
                
                <div class="info-row">
                    <span class="info-label">Статус оплаты:</span>
                    <span class="info-value">Не оплачен</span>
                </div>
            </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p>Это автоматическое уведомление об отмене заказа пользователем.</p>
            @if(isset($siteInfo['main_site']) && $siteInfo['main_site'])
